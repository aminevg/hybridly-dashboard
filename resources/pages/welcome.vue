    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
      ...
      >
        <div class="grid grid-cols-1 md:grid-cols-2">
          <!-- Documentation -->
          <welcome-item title="Documentation" url="https://laravel.com/docs">
            <template #icon>
              <svg
                fill="none"
                stroke="currentColor"
            ...
            <template #default>
              ...
              have previous experience with Laravel, we recommend reading all of
          ...
          >
            ...
            <template #default>
              ...
              you take your projects to the next level. Pair them with powerful
              ...
              >,
              <a href="https://laravel.com/docs/broadcasting" class="underline"
                >Echo</a
              >,
